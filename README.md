...
1. Download the code from [here](https://github.com/naloufi-manel/low_cost_sensor/tree/main/WaterMonitor) without the LoRa connection or from [here](https://github.com/naloufi-manel/low_cost_sensor/tree/main/WaterMonitorLora) for the LoRa connection
